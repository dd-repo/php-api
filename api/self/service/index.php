...
switch($action)
{
	...
	case 'insert':
		...
		request::forward('/service/insert'); break;
	case 'list':
	case 'view':
	case 'select':
	case 'search':
		...
		request::forward('/service/select'); break;
	case 'update':
	case 'modify':
	case 'change':
		...
		request::forward('/service/update'); break;
	case 'delete':
	case 'del':
	case 'remove':
	case 'destroy':
		...
		request::forward('/service/delete'); break;
	case 'help':
	case 'doc':
		$body = "
<h1><a href=\"/help\">API Help</a> :: <a href=\"/self/help\">self</a> :: service</h1>
<ul>
	<li><h2><a href=\"/service/insert/help\">insert</a></h2> (alias : create, add)</li>
	<li><h2><a href=\"/service/select/help\">select</a></h2> (alias : list, view, search)</li>
	<li><h2><a href=\"/service/update/help\">update</a></h2> (alias : modify, change)</li>
	<li><h2><a href=\"/service/delete/help\">delete</a></h2> (alias : del, remove, destroy)</li>
</ul>";
		responder::help($body);
		break;
	default:
