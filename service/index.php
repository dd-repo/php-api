...
$i = new index();
$i->addAlias(array('service', 'services'));
$i->setDescription("A service is a database or a plugin for applications.");
...
$i->addEntry('/quota/service/index', array('quota', 'quotas'));
return $i;
